		...
		<section class="page page--about">
			<div class="page-content">
					...
					<div class="container">
						<div class="col-group">
							<div class="col-mb-12 col-6 col-dt-3">
								<img src="./img/about-foundation.png" alt="about-foundation">
								<h3>ก่อตั้งเมื่อ</h3>
								<p>23 กุมภาพันธ์ 2539</p>
							</div>
							<div class="col-mb-12 col-6 col-dt-3">
								<img src="./img/about-location.png" alt="about-location">
								<h3>สถานที่ตั้ง</h3>
								<p>เขตลาดกระบัง กรุงเทพมหานคร</p>
							</div>
							<div class="col-mb-12 col-6 col-dt-3">
								<img src="./img/about-students.png" alt="about-students">
								<h3>นักศึกษา</h3>
								<p>จำนวน 1,200 คน</p>
							</div>
							<div class="col-mb-12 col-6 col-dt-3">
								<img src="./img/about-courses.png" alt="about-courses">
								<h3>หลักสูตร</h3>
				...
				<div class="about--dean">
					<img src="./img/person.jpg" alt="Dean">
				...
				<div class="timeline-wrapper">
					<ul class="timeline">
						<li class="event" data-date="2537">
							...
							<div class="thumb" style="background-image: url(./img/hero.jpg)"></div>
							<div class="text">
